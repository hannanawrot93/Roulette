...
THREE.Vector3.prototype = {
    constructor: THREE.Vector3, set: function (a, b, c) {
        ...
        var b =
            this.set(a.elements[0], a.elements[1], a.elements[2]).length(), c = this.set(a.elements[4], a.elements[5], a.elements[6]).length(), a = this.set(a.elements[8], a.elements[9], a.elements[10]).length();
        this.x = b;
        this.y = c;
        this.z = a;
        return this
...
THREE.Matrix4.prototype = {
    constructor: THREE.Matrix4, set: function (a, b, c, d, e, f, g, h, i, k, l, m, p, s, r, n) {
        ...
        var c =
            this.elements, d = a.x, e = a.y, f = a.z, g = Math.cos(d), d = Math.sin(d), h = Math.cos(e), e = Math.sin(e), i = Math.cos(f), f = Math.sin(f);
        if (void 0 === b || "XYZ" === b) {
        ...
        var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], h = c[8], i = c[12], k = c[1], l = c[5], m = c[9], p = c[13], s = c[2], r = c[6], n = c[10], q = c[14], z = c[3], t = c[7], x = c[11], c = c[15], u = d[0], B = d[4], G = d[8], D = d[12], w = d[1], I =
            d[5], J = d[9], E = d[13], Z = d[2], A = d[6], S = d[10], F = d[14], H = d[3], K = d[7], N = d[11], d = d[15];
        e[0] = f * u + g * w + h * Z + i * H;
        e[4] = f * B + g * I + h * A + i * K;
        e[8] = f * G + g * J + h * S + i * N;
        ...
        var c = this.elements, d = a.elements, e = d[0], f = d[4], g = d[8], h = d[12], i = d[1], k = d[5], l = d[9], m = d[13], p = d[2], s = d[6], r = d[10], n = d[14], q = d[3], z = d[7], t = d[11], x = d[15];
        ...
        var d = a.x, e = a.y, f = a.z, g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, h = e * e, i = f * f, k = Math.cos(b), l = Math.sin(b), m = 1 - k, p = d * e * m, s = d * f * m, m = e * f * m, d = d * l, r = e * l, l = f * l, f = g + (1 - g) * k, g = p + l, e = s - r, p = p - l, h = h + (1 - h) * k, l = m + d, s = s + r, m = m - d, i = i + (1 - i) * k, k = c[0], d = c[1], r = c[2], n = c[3], q = c[4], z = c[5], t = c[6],
...
THREE.Frustum.prototype = {
    constructor: THREE.Frustum, set: function (a, b, c, d, e, f) {
        ...
        var b = this.planes, c = a.elements, a = c[0], d = c[1], e = c[2], f = c[3], g = c[4], h = c[5], i = c[6], k = c[7], l = c[8], m = c[9], p = c[10], s = c[11], r = c[12], n = c[13], q = c[14], c = c[15];
...
(function (a) {
    ...
    var b = new a.Sphere, c = new a.Ray, d = new a.Plane, e = new a.Vector3, f = new a.Vector3, g = new a.Matrix4, h = function (a, b) {
        ...
        if (h instanceof a.Particle) {
            ...
            var s = h.geometry, r = s.vertices, n = h.material instanceof a.MeshFaceMaterial, q = !0 === n ? h.material.materials : null, z = h.material.side, t, x, u, B = i.precision;
...
THREE.Projector = function () {
    ...
    var e, f, g = [], h = 0, i, k, l = [], m = 0, p, s, r = [], n = 0, q, z = [], t = 0, x, u, B = [], G = 0, D, w, I = [], J = 0, E = {
        objects: [],
        sprites: [],
        lights: [],
        elements: []
    }, Z = new THREE.Vector3, A = new THREE.Vector4, S = new THREE.Box3(new THREE.Vector3(-1, -1, -1), new THREE.Vector3(1, 1, 1)), F = new THREE.Box3, H = Array(3), K = Array(4), N = new THREE.Matrix4, fa = new THREE.Matrix4, ma, eb = new THREE.Matrix4, M = new THREE.Matrix3, U = new THREE.Matrix3, ja = new THREE.Vector3, L = new THREE.Frustum, ca = new THREE.Vector4, ta = new THREE.Vector4;
...
THREE.Geometry.prototype = {
    constructor: THREE.Geometry, applyMatrix: function (a) {
        ...
        var b, c, d, e, f, g, h, i, k, l, m, p, s, r, n, q, z, t, x, u, B, G, D, w, I = [], J = [], E = new THREE.Vector3, Z = new THREE.Vector3, A = new THREE.Vector3, S = new THREE.Vector3, F = new THREE.Vector3;
        b = 0;
...
THREE.BufferGeometry.prototype = {
    constructor: THREE.BufferGeometry, applyMatrix: function (a) {
        ...
        if (this.attributes.position) {
            ...
            var e = this.attributes.position.array, f = this.attributes.normal.array, g, h, i, k, l, m, p = new THREE.Vector3, s = new THREE.Vector3, r = new THREE.Vector3, n = new THREE.Vector3, q = new THREE.Vector3;
        ...
        if (void 0 === this.attributes.index || void 0 === this.attributes.position ||
            ...
            var l, m, p, s, r, n, q, z, t, x, u, B, G, D, w, f = new THREE.Vector3, g = new THREE.Vector3, I, J, E, Z, A, S, F, H = this.offsets;
            E = 0;
...
THREE.JSONLoader.prototype.parse = function (a, b) {
    var c = new THREE.Geometry, d = void 0 !== a.scale ? 1 / a.scale : 1, e, f, g, h, i, k, l, m, p, s, r, n, q, z, t, x = a.faces;
    s = a.vertices;
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
    ...
    function h(a, b, c, d) {
        return function (f) {
            var f = f.content ? f.content : f.dae ? f.scene : f, g = d.position, h = d.rotation, i = d.quaternion, m = d.scale;
...
THREE.CanvasRenderer = function (a) {
    ...
    var k = THREE.Math.smoothstep, a = a || {}, l = this, m, p, s, r = new THREE.Projector, n = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"), q, z, t, x, u = n.getContext("2d"), B = new THREE.Color(0), G = 0, D = 1, w = 0, I = null, J = null, E = null, Z = null, A = null, S = null, F = 0, H, K, N, fa, ma = new THREE.RenderableVertex, eb = new THREE.RenderableVertex, M, U, ja, L, ca, ta, kb, $a, lb, db, La, Oa, ea = new THREE.Color, ha = new THREE.Color, V = new THREE.Color, $ = new THREE.Color,
        Y = new THREE.Color, ia = new THREE.Color, ra = new THREE.Color, na = new THREE.Color, Pa = {}, Ba = {}, fb, jb, Sa, ob, Gb, Mb, wb, Nb, Ob, xb, Hb = new THREE.Box2, Qa = new THREE.Box2, Va = new THREE.Box2, wa = new THREE.Color, xa = new THREE.Color, yb = new THREE.Color, pb = new THREE.Vector3, j, mb, vb, Wa, Ga, zb, Ib = 16;
    ...
    this.render = function (a, n) {
        ...
        function F(a, b, c, d, e, f, g, j, i, k, ab, l, m) {
            if (!(m instanceof THREE.DataTexture || void 0 ===
                ...
                var p = m.offset.x / m.repeat.x, n = m.offset.y / m.repeat.y, Jb = m.image.width * m.repeat.x, q = m.image.height * m.repeat.y, g = (g + p) * Jb, j = (1 - j + n) * q, c = c - a, d = d - b, e = e - a, f = f - b, i = (i + p) * Jb - g, k = (1 - k + n) * q - j, ab = (ab + p) * Jb -
...
THREE.WebGLRenderer = function (a) {
    ...
    function d(a, b) {
        var c = b.geometry, d = a.faces3, h = a.faces4, i = 3 * d.length + 4 * h.length, k = 1 * d.length + 2 * h.length, h = 3 * d.length + 4 * h.length, d = e(b, a), m = g(d), l = f(d), p = d.vertexColors ? d.vertexColors : !1;
    ...
    var L = this, ca = [], ta = 0, kb = null, $a = null, lb = -1, db = null, La = null, Oa = 0, ea = 0, ha = -1, V = -1, $ = -1, Y = -1, ia = -1, ra = -1, na = -1, Pa = -1, Ba = null, fb = null, jb = null, Sa = null, ob = 0, Gb = 0, Mb = 0, wb = 0, Nb = 0, Ob = 0, xb = {}, Hb = new THREE.Frustum, Qa = new THREE.Matrix4, Va = new THREE.Matrix4, wa = new THREE.Vector3, xa = new THREE.Vector3, yb = !0, pb = {
        ambient: [0, 0, 0],
    ...
    var pd = j.getParameter(j.MAX_CUBE_MAP_TEXTURE_SIZE), Wc = Wa ? j.getParameter(Wa.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 0, Bc = 0 < a, Cc = Bc && mb;
    ...
    this.renderBuffer =
        function (a, b, c, d, e, f) {
            if (!1 !== d.visible) {
                var g, k, c = x(a, b, c, d, f), a = c.attributes, b = !1, c = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0);
                c !== db && (db = c, b = !0);
                b && i();
        ...
        for (; a.__objectsAdded.length;) {
            ...
            if (!b.__webglInit && (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, void 0 !== b.geometry && void 0 === b.geometry.__webglInit && (b.geometry.__webglInit = !0, b.geometry.addEventListener("dispose", Bd)), k = b.geometry, void 0 !== k))if (k instanceof THREE.BufferGeometry) {
                ...
                if (void 0 === k.geometryGroups) {
                    var A = k, B = void 0, D = void 0, F = void 0, E = void 0, G = void 0, H = void 0, I = {}, J = A.morphTargets.length, K = A.morphNormals.length, M = m instanceof THREE.MeshFaceMaterial;
                    A.geometryGroups = {};
                    B = 0;
        ...
        for (var lb = 0, db = a.__webglObjects.length; lb < db; lb++) {
            ...
            if (la instanceof THREE.BufferGeometry) {
                ...
                for (var jb = 0, ob = la.geometryGroupsList.length; jb < ob; jb++)if (Ba = la.geometryGroupsList[jb], na = e(ma, Ba), la.buffersNeedUpdate && d(Ba, ma), xa = na.attributes && n(na), la.verticesNeedUpdate || la.morphTargetsNeedUpdate || la.elementsNeedUpdate || la.uvsNeedUpdate || la.normalsNeedUpdate || la.colorsNeedUpdate || la.tangentsNeedUpdate || xa) {
                    ...
                    if (sa.__inittedArrays) {
                        var Gb =
                            ...
                            Zc = qb.colorsNeedUpdate, pd = qb.morphTargetsNeedUpdate, xc = qb.vertices, ua = sa.faces3, va = sa.faces4, ib = qb.faces, ud = qb.faceVertexUvs[0], vd = qb.faceVertexUvs[1], yc = qb.skinIndices, tc = qb.skinWeights, uc = qb.morphTargets, $c = qb.morphNormals;
                ...
                if (la.verticesNeedUpdate || la.colorsNeedUpdate || la.normalsNeedUpdate || xa) {
                    var Eb = la, ad = j.DYNAMIC_DRAW, Pc = void 0, Qc = void 0, Rc = void 0, bd = void 0, Aa = void 0, cd = void 0, dd = void 0, ed = void 0, Cd = void 0, bb = void 0, Gc = void 0, Ea = void 0, rb = void 0, Dd = Eb.vertices, Ed = Eb.colors, Fd = Eb.normals,
                        Od = Dd.length, Pd = Ed.length, Qd = Fd.length, fd = Eb.__vertexArray, gd = Eb.__colorArray, hd = Eb.__normalArray, Rd = Eb.colorsNeedUpdate, Sd = Eb.normalsNeedUpdate, wd = Eb.__webglCustomAttributesList;
                ...
                if (la.verticesNeedUpdate ||
                    ...
                    var fc = la, yd = j.DYNAMIC_DRAW, Vc = ma, tb = void 0, gc = void 0, hc = void 0, da = void 0, ic = void 0, vc = void 0, od = fc.vertices, zd = od.length, Ad = fc.colors, Ld = Ad.length, zc = fc.__vertexArray, Ac = fc.__colorArray, nc = fc.__sortArray, Md = fc.verticesNeedUpdate, Nd = fc.colorsNeedUpdate, oc = fc.__webglCustomAttributesList, Kb = void 0, Ic = void 0, pa = void 0, Lb = void 0, Da = void 0, ba = void 0;
                    if (Vc.sortParticles) {
                        Va.copy(Qa);
    ...
    crossOrigin: "anonymous", loadTexture: function (a, b, c, d) {
        ...
        for (var h = h[1] + 4, f = d.width, g = d.height, i = d.isCubemap ?
            ...
            for (var l = 0; l < d.mipmapCount; l++) {
                var m = Math.max(4, f) / 4 * Math.max(4, g) / 4 * e, p = {
        ...
        for (var h = g.getImageData(0,
            ...
            var p = 0 > m - 1 ? 0 : m - 1, s = m + 1 > e - 1 ? e - 1 : m + 1, r = 0 > l - 1 ? 0 : l - 1, n = l + 1 > d - 1 ? d - 1 : l + 1, q = [], z = [0, 0, h[4 * (m * d + l)] / 255 * b];
        ...
        for (k = e - 1; 2 < e;) {
            ...
            a:{
                ...
                if (1E-10 > (n - s) * (t - r) - (q - r) * (z - s))p = !1; else {
                    var B = void 0, G = void 0, D = void 0, w = void 0, I = void 0, J = void 0, E = void 0, Z = void 0, A = void 0, S = void 0, A = Z = E = u = x = void 0, B = z - n, G = t - q, D = s - z, w = r - t, I = n - s, J = q - r;
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    ...
    for (h = 0; h < d; h++) {
        ...
        for (i = 0; i < e; i++) {
            var s = k[i][h], r = k[i + 1][h], n = k[i + 1][h + 1], q = k[i][h + 1], z = m.clone(), t = m.clone(), x = p.clone(), u = p.clone(), B = l[i][h].clone(), G = l[i + 1][h].clone(), D = l[i + 1][h + 1].clone(), w = l[i][h + 1].clone();
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    function e(c, d) {
        ...
        for (M = c.length; 0 <= --M;) {
            ...
            for (var g = 0, h = s + 2 * l,
                     g = 0; g < h; g++) {
                var i = fa * g, k = fa * (g + 1), m = d + e + i, i = d + f + i, p = d + f + k, k = d + e + k, n = c, q = g, r = h, u = e, w = f, m = m + Z, i = i + Z, p = p + Z, k = k + Z;
    ...
    var h = void 0 !== b.amount ? b.amount :
        100, i = void 0 !== b.bevelThickness ? b.bevelThickness : 6, k = void 0 !== b.bevelSize ? b.bevelSize : i - 2, l = void 0 !== b.bevelSegments ? b.bevelSegments : 3, m = void 0 !== b.bevelEnabled ? b.bevelEnabled : !0, p = void 0 !== b.curveSegments ? b.curveSegments : 12, s = void 0 !== b.steps ? b.steps : 1, r = b.extrudePath, n, q = !1, z = b.material, t = b.extrudeMaterial, x = void 0 !== b.UVGenerator ? b.UVGenerator : THREE.ExtrudeGeometry.WorldUVGenerator, u, B, G, D;
...
THREE.SphereGeometry = function (a, b, c, d, e, f, g) {
    ...
    for (c = 0; c < this.heightSegments; c++)for (b = 0; b < this.widthSegments; b++) {
        var d = h[c][b + 1], e = h[c][b], f = h[c + 1][b], g = h[c + 1][b + 1], k = this.vertices[d].clone().normalize(), l = this.vertices[e].clone().normalize(), m = this.vertices[f].clone().normalize(), p = this.vertices[g].clone().normalize(), s = i[c][b + 1].clone(), r = i[c][b].clone(), n = i[c + 1][b].clone(),
            q = i[c + 1][b + 1].clone();
...
THREE.LensFlarePlugin = function () {
    ...
    this.render = function (a, d, e, f) {
        ...
        if (t) {
            var x = new THREE.Vector3, u = f / e, B = 0.5 * e, G = 0.5 * f, D = 16 / f, w = new THREE.Vector2(D * u, D), I = new THREE.Vector3(1, 1, 0), J = new THREE.Vector2(1, 1), E = s, D = p;
            b.useProgram(m);
...
THREE.SpritePlugin = function () {
    ...
    this.init = function (a) {
        ...
        b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, h);
        b.bufferData(b.ELEMENT_ARRAY_BUFFER, f, b.STATIC_DRAW);
        var a = THREE.ShaderSprite.sprite, p = b.createProgram(), s = b.createShader(b.FRAGMENT_SHADER), r = b.createShader(b.VERTEX_SHADER), n = "precision " + d + " float;\n";
